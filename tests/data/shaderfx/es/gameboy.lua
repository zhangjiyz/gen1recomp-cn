return {["parameter_overrides"]={{["name"]="response_time",["value"]=0.33,},},["pass_count"]=5,["passes"]={{["alias"]="PASS0",["filter"]="nearest",["float_framebuffer"]=false,["fragment"]="#version 100\
...
uniform highp sampler2D LIBRA_TEXTURE_OriginalHistory1;\
uniform highp sampler2D LIBRA_TEXTURE_OriginalHistory2;\
uniform highp sampler2D LIBRA_TEXTURE_OriginalHistory3;\
uniform highp sampler2D LIBRA_TEXTURE_OriginalHistory4;\
uniform highp sampler2D LIBRA_TEXTURE_OriginalHistory5;\
uniform highp sampler2D LIBRA_TEXTURE_OriginalHistory6;\
...
\
",["wrap_mode"]="clamp_to_border",},{["alias"]="PASS1",["filter"]="nearest",["float_framebuffer"]=false,["fragment"]="#version 100\
precision highp float;\
precision highp int;\
\
struct LIBRA_UBO_FRAGMENT\
...
\
",["wrap_mode"]="clamp_to_border",},{["alias"]="PASS2",["filter"]="nearest",["float_framebuffer"]=false,["fragment"]="#version 100\
precision highp float;\
precision highp int;\
\
...
\
",["wrap_mode"]="clamp_to_border",},{["alias"]="PASS3",["filter"]="nearest",["float_framebuffer"]=false,["fragment"]="#version 100\
precision highp float;\
precision highp int;\
\
const float _17[5] = float[](0.0, 1.0, 2.0, 3.0, 4.0);\
...
\
",["wrap_mode"]="clamp_to_border",},{["alias"]="PASS4",["filter"]="nearest",["float_framebuffer"]=false,["fragment"]="#version 100\
precision highp float;\
precision highp int;\
\
struct LIBRA_UBO_FRAGMENT\
...
\
uniform highp sampler2D LIBRA_TEXTURE_COLOR_PALETTE;\
uniform highp sampler2D LIBRA_TEXTURE_PassOutput1;\
uniform highp sampler2D LIBRA_TEXTURE_BACKGROUND;\
uniform highp sampler2D LIBRA_TEXTURE_Source;\
\
varying vec2 LIBRA_VARYING_0;\
varying vec2 LIBRA_VARYING_3;\
